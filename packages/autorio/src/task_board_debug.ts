...
const debug_render = (() => {
  ...
  return {
    destroy_debug_popout,
    fill_debug_body,
    build_debug_activity,
    refresh_debug_activity,
    build_debug_popout,
  }
})()
...
export function render_debug_popout(player: LuaPlayer, console_open: boolean, board: any, runtime: any, synced_tick: number | undefined) {
  if (!console_open) {
    ...
    debug_render.destroy_debug_popout(player)
    return
  }
  ...
  debug_render.build_debug_popout(player, board, runtime, synced_tick)
}
