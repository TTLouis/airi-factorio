...
export function build_swarm_coordination_snapshot(swarm: SwarmStorage, tick: number, limit = 12) {
  ...
  return {
    ...
    counts: {
      ...
      agents: agentCount,
      actors: actorCount,
      openWork: board.counts.openWork,
      executingWork: board.counts.executingWork,
      blockedWork: board.counts.blockedWork,
      openRequests: board.counts.openRequests,
      activeClaims: board.counts.activeClaims,
