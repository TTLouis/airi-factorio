...
let session='',mode='player',actorId=18,epoch=0,stopping=false;const sockets=new Set();
...
test('session starts zero-player standalone NPC over authenticated loopback RCON and saves cleanly', async t => {
